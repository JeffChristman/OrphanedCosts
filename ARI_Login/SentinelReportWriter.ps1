...
.EXAMPLE
    .\Analyze-Sentinel.ps1 -InputPath .\Sentinel-Raw-vaecla-security-gov-20251222.json

.EXAMPLE
    .\Analyze-Sentinel.ps1 -InputPath C:\repos\ps\output\results.json -OutputPath .\delta.html
